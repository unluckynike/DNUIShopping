			...
			<div class="col-md-12 ">
				...
				<ol class="breadcrumb text-right" id="info">
					<c:if test="${sessionScope['_LOGIN_USER_']==null}">
						...
						<li><a href="#"
							onclick="showCart('${pageContext.request.contextPath}','${sessionScope.goodslist}')">购物车
					...
					<c:if test="${sessionScope['_LOGIN_USER_']!=null}">
						...
						<li><a
							href="${pageContext.request.contextPath}/order/getMyOrders">我的订单</a></li>
						<li><a
								...
								<ul class="dropdown-menu">
									<c:forEach items="${catelist}" var="c" varStatus="vs">
										<c:forEach items="${c.childlist}" var="cl" varStatus="i">
											<li><a
												href="${pageContext.request.contextPath}/goods/goodsCate.action?childid=${cl.childid}">${cl.childname}</a></li>
										</c:forEach>
										<li class="divider"></li>
									</c:forEach>
								</ul></li>
