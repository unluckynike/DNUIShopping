						...
						<div id="tsImgSCon">
							<ul>
								<c:forEach items="${goodsDetail.pics }" var="s" varStatus="vs">
								    <c:if test="${vs.first}">
								       <li onclick="showPic(0)" rel="MagicZoom"  class="tsSelectImg"><img height="42" width="42" src="${pageContext.request.contextPath}${s.picUrl}" tsImgS="${pageContext.request.contextPath}${s.picUrl}" /></li>
								    </c:if>
									<li onclick="showPic(0)" rel="MagicZoom"><img height="42" width="42" src="${pageContext.request.contextPath}${s.picUrl}" tsImgS="${pageContext.request.contextPath}${s.picUrl}" /></li>
								</c:forEach>
							</ul>
						</div>
